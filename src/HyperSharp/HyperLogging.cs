...
namespace OoLunar.HyperSharp
{
    internal static class HyperLogging
    {
        ...
        public static readonly Action<ILogger, Ulid, Exception?> ConnectionClosing = LoggerMessage.Define<Ulid>(LogLevel.Debug, new EventId(2, nameof(ConnectionClosing)), "Closing connection {ConnectionId}...");
